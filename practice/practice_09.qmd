...
- [ ] `hrs_11_cesd_filled` created with `replace_na()`, with question answered (Q4 Part A)
- [ ] `hrs_12_degree_filled` created with `fct_na_value_to_level()` (Q4 Part B)
- [ ] `degree` vs. `degree_filled` checked with `tabyl()` (Q4 Part C)
